        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "event_datetime": {
                        "type": "string",
                        "description": "Fecha y hora del evento en formato "
                                       "YYYY-MM-DD HH:MM",
                    },
                    "description": {
                        "type": "string",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "expires_at": {
                        "type": "string",
                        "description": "Fecha de expiración en formato "
                                       "YYYY-MM-DD (opcional)",
                    },
                },
                "required": ["message"],
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "top_k": {
                        "type": "integer",
                        "description": "Numero de fragmentos a recuperar "
                                       "(default 5, max 10)",
                    },
                },
                "required": ["query"],
